...
const CMSG_ITEM_NAME_QUERY: u32 = 0x02C4;
const SMSG_ITEM_NAME_QUERY_RESPONSE: u16 = 0x02C5;
...
const CMSG_GROUP_INVITE: u32 = 0x006E;
const SMSG_GROUP_INVITE: u16 = 0x006F;
const CMSG_GROUP_CANCEL: u32 = 0x0070;
const CMSG_GROUP_ACCEPT: u32 = 0x0072;
const CMSG_GROUP_DECLINE: u32 = 0x0073;
const SMSG_GROUP_DECLINE: u16 = 0x0074;
const CMSG_GROUP_UNINVITE: u32 = 0x0075;
const CMSG_GROUP_UNINVITE_GUID: u32 = 0x0076;
const SMSG_GROUP_UNINVITE: u16 = 0x0077;
const CMSG_GROUP_SET_LEADER: u32 = 0x0078;
const SMSG_GROUP_SET_LEADER: u16 = 0x0079;
const CMSG_LOOT_METHOD: u32 = 0x007A;
const CMSG_GROUP_DISBAND: u32 = 0x007B;
const SMSG_GROUP_DESTROYED: u16 = 0x007C;
const SMSG_GROUP_LIST: u16 = 0x007D;
const SMSG_PARTY_COMMAND_RESULT: u16 = 0x007F;
...
const SMSG_FORCE_MOVE_ROOT: u16 = 0x00E8;
const CMSG_FORCE_MOVE_ROOT_ACK: u32 = 0x00E9;
const SMSG_FORCE_MOVE_UNROOT: u16 = 0x00EA;
const CMSG_FORCE_MOVE_UNROOT_ACK: u32 = 0x00EB;
...
const CMSG_STANDSTATECHANGE: u32 = 0x0101;
...
const CMSG_AUTOSTORE_BAG_ITEM: u32 = 0x010B;
...
const SMSG_ITEM_PUSH_RESULT: u16 = 0x0166;
const SMSG_TRIGGER_CINEMATIC: u16 = 0x00FA;
const SMSG_DESTROY_OBJECT: u16 = 0x00AA;
const SMSG_MONSTER_MOVE: u16 = 0x00DD;
const SMSG_SPLINE_SET_RUN_SPEED: u16 = 0x02FE;
const SMSG_SPLINE_SET_RUN_BACK_SPEED: u16 = 0x02FF;
const SMSG_SPLINE_SET_SWIM_SPEED: u16 = 0x0300;
const SMSG_SPLINE_SET_WALK_SPEED: u16 = 0x0301;
const SMSG_SPLINE_SET_SWIM_BACK_SPEED: u16 = 0x0302;
...
const SMSG_SPELL_START: u16 = 0x0131;
const SMSG_SPELL_FAILURE: u16 = 0x0133;
const SMSG_SPELL_DELAYED: u16 = 0x01E2;
const CMSG_SET_SELECTION: u32 = 0x013D;
const CMSG_SET_TARGET_OBSOLETE: u32 = 0x013E;
...
const SMSG_SPELLHEALLOG: u16 = 0x0150;
const SMSG_SPELLENERGIZELOG: u16 = 0x0151;
...
const SMSG_START_MIRROR_TIMER: u16 = 0x01D9;
const SMSG_STOP_MIRROR_TIMER: u16 = 0x01DB;
...
const CMSG_QUESTLOG_REMOVE_QUEST: u32 = 0x0194;
const SMSG_QUESTLOG_FULL: u16 = 0x0195;
...
const CMSG_BUYBACK_ITEM: u32 = 0x0290;
...
const SMSG_PLAY_SPELL_VISUAL: u16 = 0x01F3;
const SMSG_ENVIRONMENTALDAMAGELOG: u16 = 0x01FC;
const SMSG_SPELLNONMELEEDAMAGELOG: u16 = 0x0250;
const SMSG_PLAY_SPELL_IMPACT: u16 = 0x01F7;
const SMSG_SPELL_FAILED_OTHER: u16 = 0x02A6;
...
const CMSG_GROUP_CHANGE_SUB_GROUP: u32 = 0x027E;
const CMSG_REQUEST_PARTY_MEMBER_STATS: u32 = 0x027F;
const MSG_QUERY_NEXT_MAIL_TIME: u32 = 0x0284;
const CMSG_GROUP_RAID_CONVERT: u32 = 0x028E;
const CMSG_GROUP_ASSISTANT_LEADER: u32 = 0x028F;
const CMSG_MEETINGSTONE_INFO: u32 = 0x0296;
const SMSG_LOOT_ALL_PASSED: u16 = 0x029E;
const SMSG_LOOT_ROLL_WON: u16 = 0x029F;
const CMSG_LOOT_ROLL: u32 = 0x02A0;
const SMSG_LOOT_START_ROLL: u16 = 0x02A1;
const SMSG_LOOT_ROLL: u16 = 0x02A2;
const CMSG_LOOT_MASTER_GIVE: u32 = 0x02A3;
const SMSG_LOOT_MASTER_LIST: u16 = 0x02A4;
const SMSG_SPELLLOGMISS: u16 = 0x024B;
...
const SMSG_STANDSTATE_UPDATE: u16 = 0x029D;
const SMSG_UPDATE_OBJECT: u16 = 0x00A9;
const SMSG_SET_PROFICIENCY: u16 = 0x0127;
const SMSG_UPDATE_AURA_DURATION: u16 = 0x0137;
const SMSG_PERIODICAURALOG: u16 = 0x024E;
...
const CHAT_MSG_PARTY: u32 = 0x01;
const CHAT_MSG_YELL: u32 = 0x05;
const CHAT_MSG_EMOTE: u32 = 0x08;
const CHAT_MSG_SYSTEM: u32 = 0x0A;
const CHAT_TAG_NONE: u8 = 0;
const LANG_UNIVERSAL: u32 = 0;
...
const GLOBAL_ACCOUNT_DATA_MASK: u32 = 0x15;
const PER_CHARACTER_ACCOUNT_DATA_MASK: u32 = 0xEA;
...
const UNIT_VIRTUAL_ITEM_SLOT_DISPLAY: usize = 0x025;
const UNIT_VIRTUAL_ITEM_INFO: usize = 0x028;
...
const PLAYER_FIELD_VENDORBUYBACK_SLOT_1: usize = 0x270;
const PLAYER_FIELD_COMBO_TARGET: usize = 0x2CA;
...
const PLAYER_FIELD_BUYBACK_PRICE_1: usize = 0x4CA;
const PLAYER_FIELD_BUYBACK_TIMESTAMP_1: usize = 0x4D6;
...
const EQUIP_ERR_INVENTORY_FULL: u8 = 50;
const EQUIP_ERR_ITEM_NOT_FOUND: u8 = 23;
const EQUIP_ERR_CANT_EQUIP_LEVEL_I: u8 = 1;
const EQUIP_ERR_CANT_EQUIP_SKILL: u8 = 2;
const EQUIP_ERR_ITEM_DOESNT_GO_TO_SLOT: u8 = 3;
const EQUIP_ERR_NONEMPTY_BAG_OVER_OTHER_BAG: u8 = 5;
const EQUIP_ERR_NO_REQUIRED_PROFICIENCY: u8 = 8;
const EQUIP_ERR_YOU_CAN_NEVER_USE_THAT_ITEM: u8 = 10;
const EQUIP_ERR_ITEM_CANT_BE_EQUIPPED: u8 = 20;
const EQUIP_ERR_CAN_ONLY_DO_WITH_EMPTY_BAGS: u8 = 31;
const EQUIP_ERR_CANT_EQUIP_RANK: u8 = 63;
const EQUIP_ERR_CANT_EQUIP_REPUTATION: u8 = 64;
const BUY_ERR_NOT_ENOUGHT_MONEY: u8 = 2;
const BUY_ERR_CANT_FIND_ITEM: u8 = 0;
...
const GO_FLAG_INTERACT_COND: u32 = 0x0000_0004;
const GO_FLAG_NO_INTERACT: u32 = 0x0000_0010;
const GO_DYNFLAG_LO_ACTIVATE: u32 = 0x0000_0001;
const GO_DYNFLAG_LO_SPARKLE: u32 = 0x0000_0008;
const GO_TYPE_CHEST: u8 = 3;
const GO_TYPE_QUESTGIVER: u8 = 2;
...
const DIALOG_STATUS_UNAVAILABLE: u32 = 1;
...
const SPELL_HIT_TYPE_CRIT: u32 = 0x0000_0002;
const SPELL_MISS_MISS: u8 = 1;
const SPELL_MISS_RESIST: u8 = 2;
const SPELL_MISS_DODGE: u8 = 3;
const SPELL_MISS_PARRY: u8 = 4;
const SPELL_MISS_BLOCK: u8 = 5;
...
const GOSSIP_ICON_CHAT: u8 = 0;
const GOSSIP_ICON_VENDOR: u8 = 1;
const GOSSIP_ICON_TRAINER: u8 = 3;
const GOSSIP_ICON_INTERACT_1: u8 = 4;
...
const DB_TRAINER_GOSSIP_OPTION: &str = "I seek training.";
const DB_TRAINER_GOSSIP_TEXT: &str =
    "The Rust world stack is answering DB-backed trainer gossip now.";
const DB_TRAINER_GREETING: &str = "What can I teach you?";
...
const WORLD_TICK_MILLIS: u64 = 100;
...
const DB_CREATURE_RUN_BACK_SPEED_YARDS_PER_SEC: f32 = 4.5;
const DB_CREATURE_SWIM_SPEED_YARDS_PER_SEC: f32 = 4.722222;
const DB_CREATURE_SWIM_BACK_SPEED_YARDS_PER_SEC: f32 = 2.5;
...
const DB_CREATURE_IDLE_MOTION_FAILED_RETRY_MILLIS: u64 = 500;
#[allow(dead_code)]
const DB_CREATURE_IDLE_MOTION_STARTS_PER_TICK: usize = usize::MAX;
...
const SPELL_CAST_TARGET_GAMEOBJECT: u16 = 0x0800;
const SPELL_CAST_TARGET_LOCKED: u16 = 0x4000;
const CAST_FLAG_SPELL_GO: u16 = 0x0100;
const CAST_FLAG_SPELL_START: u16 = 0x0002;
const CAST_FLAG_ITEM_CASTER: u16 = 0x0040;
const OPENING_SPELL_ID: u32 = 6478;
const OPENING_SPELL_CAST_TIME_MS: u32 = 5_000;
const SPELL_FAILED_OUT_OF_RANGE: u8 = 0x59;
const SPELL_FAILED_LINE_OF_SIGHT: u8 = 0x2A;
const SPELL_FAILED_NOPATH: u8 = 0x32;
const SPELL_FAILED_NOT_BEHIND: u8 = 0x33;
const SPELL_FAILED_NO_COMBO_POINTS: u8 = 0x46;
const SPELL_FAILED_UNIT_NOT_INFRONT: u8 = 0x7C;
const SPELL_FAILED_NOT_READY: u8 = 0x3C;
const SPELL_FAILED_NO_POWER: u8 = 0x4D;
const SPELL_FAILED_INTERRUPTED: u8 = 0x23;
const SPELL_FAILED_CASTER_DEAD: u8 = 0x13;
