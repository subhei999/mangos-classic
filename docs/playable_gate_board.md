...
| G7 Death + Respawn | Red | Player can die, release spirit, resurrect/respawn, DB state sane | Creature death/corpse/respawn timing and visibility are now CMaNGOS-like enough to support player death work next | #44 | Start player death/release/ghost/resurrection as the next vertical slice |
