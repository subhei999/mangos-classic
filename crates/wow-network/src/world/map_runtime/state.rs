...
pub(in crate::world) struct PlayerRuntime {
    ...
    pub(in crate::world) aura_state: u32,
    pub(in crate::world) reactive_defense_expires_at: Option<Instant>,
    pub(in crate::world) reactive_overpower_expires_at: Option<Instant>,
